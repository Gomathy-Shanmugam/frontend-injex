...
const CurriculumCourse = ({ showSummary: externalShowSummary }: { showSummary?: boolean }) => {
  ...
  const addingChapterTimeoutRef = useRef<{ [key: number]: NodeJS.Timeout | null }>({})
  ...
  const handleFlipbookUpload = (e: React.ChangeEvent<HTMLInputElement>) => {
    if (e.target.files?.[0] && activeItem) {
      ...
      const mockPages = Array.from({ length: 10 }, (_, i) => `/placeholder.svg?height=400&width=300&text=Page ${i + 1}`)
      ...
      setModules((prev) => {
        ...
        if (
          ...
          if (
            !newModules[activeItem.moduleIndex].chapters[activeItem.chapterIndex].lessons[activeItem.lessonIndex]
              .flipbooks
          ) {
...
This document contains formatted text, images, tables, other Word-specific formatting that requires Microsoft Word or a compatible application to view properly.`,
    ...
    (modIndex: number, source = "unknown") => {
      ...
      addingChapterTimeoutRef.current[modIndex] = setTimeout(() => {
        ...
        setModules((prevModules) => {
          ...
          console.log(`📊 New chapters count:`, newModules[modIndex].chapters.length)
          return newModules
        })
  ...
  const getCurrentFlipbooks = () => {
    ...
    if (activeItem.chapterIndex !== undefined && activeItem.lessonIndex !== undefined) {
      return (
        modules[activeItem.moduleIndex].chapters[activeItem.chapterIndex].lessons[activeItem.lessonIndex].flipbooks ||
        []
      )
    }
                          ...
                          <div className="external-actions-in-expanded">
                            ...
                            <button
                              ...
                              onClick={(e) => {
                                e.preventDefault()
                                e.stopPropagation()
                                console.log(`Expanded view: Adding chapter to module ${modIndex}`)
                      ...
                      <div className="external-actions">
                        ...
                        <button
                          ...
                          onClick={(e) => {
                            e.preventDefault()
                            e.stopPropagation()
                            console.log(`Collapsed view: Adding chapter to module ${modIndex}`)
                                    ...
                                    {chapter.lessons.map((lesson: any, lessonIndex: number) => (
                                      <div key={lessonIndex} className="lesson-item-row">
                                        ...
                                        <div className="actions-column">
                                          <button
                                            className="edit-module-btn"
                                            onClick={() => openPopup("lesson", moduleIndex, chapterIndex, lessonIndex)}
                                          >
                                            <svg
                                              width="16"
                                              height="16"
                                      ...
                                      <div key={quizIndex} className="lesson-item-row">
                                        ...
                                        <div className="actions-column">
                                          ...
                                          <button
                                            className="delete-module-btn"
                                            onClick={() =>
                                              confirmDelete("quiz", quiz, moduleIndex, undefined, undefined, quizIndex)
                                            }
                                          >
                                            <svg
                                              width="16"
                          ...
                          {selectedFile.type === "pdf" ? (
                            ...
                            >
                              <svg
                                ...
                                stroke="currentColor"
                                strokeWidth="2"
                                style={{ marginBottom: "20px", color: "#e74c3c" }}
                              >
                                <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" />
                                <polyline points="14 2 14 8 20 8" />
                                <line x1="16" y1="13" x2="8" y2="13" />
                              ...
                              <p style={{ margin: "0", color: "#999", fontSize: "14px" }}>
                                Click the fullscreen button above to view this PDF document, or use the download button
              ...
              <div className="assignment-main-content">
                <div className="assignment-left-section">
                  ...
                  <div className="assignment-file-upload">
                    ...
                    <input type="file" multiple ref={assignmentFileInputRef} style={{ display: "none" }} />
                    <small>Maximum upload size limit of 30 MB</small>
                  </div>
                </div>
                  ...
                  <div className="assignment-checkboxes">
                    <label className="assignment-checkbox-label">
                      <input
                        ...
                        onChange={(e) =>
                          setAssignmentData((prev) => ({ ...prev, allowCollaboration: e.target.checked }))
                        }
                      />
            ...
            <div className="quiz-content">
              ...
              <div className="quiz-questions">
                <div className="quiz-questions-header">
                  <h3>Questions</h3>
                  <button className="quiz-add-question-btn" onClick={() => setShowQuestionForm(true)}>
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                      <circle cx="12" cy="12" r="10" />
                      <line x1="12" y1="8" x2="12" y2="16" />
                      <line x1="8" y1="12" x2="16" y2="12" />
                    ...
                    <div key={question.id} className="quiz-question-item">
                      <div className="quiz-question-header">
                        ...
                        <div className="quiz-question-actions">
                          <button className="quiz-edit-btn" onClick={() => setEditingQuestion(question.id)}>
                            <svg
                              width="16"
                              height="16"
                              viewBox="0 0 24 24"
                          ...
                          <button className="quiz-delete-btn" onClick={() => removeQuestion(question.id)}>
                            <svg
                              width="16"
                              height="16"
                              viewBox="0 0 24 24"
                ...
                {showQuestionForm && (
                  <div className="quiz-question-form">
                    ...
                    <div className="quiz-form-group">
                      <label>
                        Answers <span className="mark-correct">(Mark the correct answer with radio button)</span>
                      </label>
                    ...
                    <div className="quiz-edit-actions">
                      <button className="quiz-cancel-edit-btn" onClick={() => setShowQuestionForm(false)}>
                        Cancel
                      </button>
                      <button className="quiz-add-question-yellow-btn" onClick={addQuestionToList}>
                        Add Question
                      </button>
                    </div>
                  </div>
              ...
              <div className="delete-item-info">
                ...
                <span>
                  {deleteConfirmation.type === "module" &&
                    `Module: ${deleteConfirmation.item.title || deleteConfirmation.item.id}`}
                  {deleteConfirmation.type === "chapter" && `Chapter: ${deleteConfirmation.item.title}`}
                  {deleteConfirmation.type === "lesson" && `Lesson: ${deleteConfirmation.item.title}`}
                  {deleteConfirmation.type === "quiz" && `Quiz: ${deleteConfirmation.item.title}`}
                  {deleteConfirmation.type === "assignment" && `Assignment: ${deleteConfirmation.item.title}`}
                </span>
              </div>
      ...
      {selectedFile && isFullScreen && (
        <div className="fullscreen-overlay">
          ...
          <div className="fullscreen-content">
            {selectedFile.type === "pdf" ? (
              ...
              >
                {selectedFile.url ? (
                  ...
                  >
                    ...
                    <h2 style={{ margin: "0 0 20px 0", color: "#333" }}>PDF Document</h2>
                    <p style={{ margin: "0 0 30px 0", color: "#666", fontSize: "18px" }}>{selectedFile.name}</p>
                    <p style={{ margin: "0 0 30px 0", color: "#999", fontSize: "16px", maxWidth: "600px" }}>
                      This PDF document cannot be displayed directly in the browser due to security restrictions. Please
                      use the download button above to save and view the file in your preferred PDF viewer.
                    </p>
                    <a
                      href={selectedFile.url}
                      download={selectedFile.name}
            ...
            ) : selectedFile.type === "word" || selectedFile.type === "docx" || selectedFile.type === "doc" ? (
              <div
                style={{
                  display: "flex",
                  flexDirection: "column",
              ...
              >
                ...
                <h2 style={{ margin: "0 0 20px 0", color: "#333" }}>Word Document</h2>
                <p style={{ margin: "0 0 30px 0", color: "#666", fontSize: "18px" }}>{selectedFile.name}</p>
                <p style={{ margin: "0 0 30px 0", color: "#999", fontSize: "16px", maxWidth: "600px" }}>
                  This Word document cannot be displayed directly in the browser. Please use the download button to save
                  and view the file in Microsoft Word or a compatible application.
                </p>
                <a
                  href={selectedFile.url}
                  download={selectedFile.name}
              ...
              <pre className="fullscreen-file-content">{selectedFile.content}</pre>
            )}
          </div>
        </div>
      )}
